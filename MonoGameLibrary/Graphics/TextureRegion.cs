...
{
    /// <summary>
    /// Represents a rectangular region of a texture, typically used for rendering a portion of a texture atlas.
    /// </summary>
    /// <remarks>A <see cref="TextureRegion"/> is often used in graphics programming to efficiently manage and
    /// render parts of a larger texture. This can be useful in scenarios such as sprite animations or UI element
    /// rendering, where multiple images are packed into a single texture to reduce draw calls and improve
    /// performance.</remarks>
