...
namespace MonoGameLibrary.Graphics
{
    ...
    public class Tilemap
    {
        ...
        /// <summary>
        /// Renders the tile map using the specified sprite batch.
        /// </summary>
        /// <remarks>This method iterates over each tile in the map, calculates its position based on its
        /// index, and draws it using the provided sprite batch. Ensure that the sprite batch is properly initialized
        /// and begun before calling this method, and ended after the drawing is complete.</remarks>
        /// <param name="spriteBatch">The <see cref="SpriteBatch"/> used to draw the tiles. This parameter cannot be null.</param>
